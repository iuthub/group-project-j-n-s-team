                ...
                <div class="col-12 col-md-8 col-lg-8 col-xl-10">
                    ...
                    <div class="row align-items-center">
                        <div class="col mt-0 p-2">
                            <h1 style="color: #fff; font-size:4vw; text-align:center">Fill the application form.</h1>
                        </div>
                    </div>
                    ...
                    <form action="{{ route('save_application') }}" method="post" style="background-color: #fff; padding:20px; border-radius:10px;" enctype="multipart/form-data">
                        {{ csrf_field() }}

                        <div class="row align-items-center">
                            <div class="col mt-4">
                                <label for="body" class="text-center">Write your application.</label>
                                <textarea class="@error('body') border-danger @enderror"
                                          name="body" id="body" placeholder="Write your application here "
                                          style="height:200px; width: 100%; border-radius:9px; border:1px solid black; background-color: #F3EFEF;"></textarea>
                                @error('body')
                        ...
                        <div class="row align-items-center mt-3">
                            <div class="col-12 col-md-12 col-lg-4 col-xl-4">
                                <select name="region" id="region"
                                        class="col-12 m-2 @error('region') border-danger @enderror"
                                        style="height: 3rem; border-radius:5px; background-color:#F3EFEF;">
                            ...
                            <div class="col-12 col-sm-12 col-lg-4 col-xl-4">
                                <select name="schoolname" id="schoolname"
                                        class="col-12 m-2 @error('schoolname') border-danger @enderror"
                                        style="height: 3rem; border-radius:5px; background-color:#F3EFEF;">
                        ...
                        <div class="row justify-content-center mt-2">
                            <div class="col">
                                <button class="form-control btn-primary" style="height: 7vh;" type="submit">
                                    Save
                                </button>
                            </div>
                        </div>
