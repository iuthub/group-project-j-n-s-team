        ...
        <div class="container topmargin">
            <div class="row justify-content-center">
                <div class="col-12 col-md-8 col-lg-8 col-xl-10">
                    ...
                    @endif
                    <form action="{{route('save_application')}}" method="post"
                        ...
                        <div class="row align-items-center">
                            <div class="col mt-4">
                                ...
                                <textarea class="@error('body') border-danger @enderror"
                                          name="body" id="body" placeholder="Right apply here " value="{{old('body')}}"
                                          style="height:200px; width: 100%; border-radius:9px; border:1px solid black; background-color: #F3EFEF;">
            </textarea>
                                @error('body')
                        ...
                        <div class="row align-items-center mt-3">
                            <div class="col-12 col-md-12 col-lg-4 col-xl-4">
                                <select name="region" id="region" class="col-12 m-2 "
                            ...
                            <div class="col-12 col-sm-12 col-lg-4 col-xl-4">
                                <select name="type" id="type" class="col-12 m-2"
                                        style="height: 3rem; border-radius:5px; background-color:#F3EFEF;">
                            ...
                            <div class="col-12 col-sm-12 col-lg-4 col-xl-4">
                                <select name="schoolname" id="schoolname" class="col-12 m-2"
                                        style="height: 3rem; border-radius:5px; background-color:#F3EFEF;">
                        ...
                        <div class="row justify-content-center mt-2">
                            <div class="col">
                                <button class="form-control btn-primary" style="height: 7vh;">Save</button>
                            </div>
                        </div>
                    </form>
                </div>
